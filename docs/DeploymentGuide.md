...
| argo-workflows.images.tag | string | `"v3.7.11"` | the Docker image version for the Argo workload |
...
| to.image.tag | string | `"v2.19.0"` | the Docker image version for the SRM Tool Orchestration workloads (tools use the web.image.tag version)|
...
| web.image.tag | string | `"v2026.6.4"` | the Docker image version for the SRM web workload |
