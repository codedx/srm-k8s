...
| to.image.tag | string | `"v2.10.0"` | the Docker image version for the SRM Tool Orchestration workloads (tools use the web.image.tag version)|
...
| web.image.tag | string | `"v2025.3.3"` | the Docker image version for the SRM web workload |
