...
| to.image.tag | string | `"v2.16.0"` | the Docker image version for the SRM Tool Orchestration workloads (tools use the web.image.tag version)|
...
| web.image.tag | string | `"v2025.9.0"` | the Docker image version for the SRM web workload |
