...
| to.image.tag | string | `"v2.18.0"` | the Docker image version for the SRM Tool Orchestration workloads (tools use the web.image.tag version)|
...
| web.image.tag | string | `"v2026.3.2"` | the Docker image version for the SRM web workload |
