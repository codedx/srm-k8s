...
- repo.blackduck.com/containers/argoproj/workflow-controller:v3.7.0
- repo.blackduck.com/containers/argoproj/argoexec:v3.7.0
...
'argoproj/argoexec:v3.7.0' | ForEach-Object {
