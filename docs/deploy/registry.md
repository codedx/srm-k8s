...
```
$ docker pull repo.blackduck.com/containers/codedx/codedx-tomcat:v2026.6.4
$ docker tag repo.blackduck.com/containers/codedx/codedx-tomcat:v2026.6.4 id.dkr.ecr.us-east-2.amazonaws.com/codedx/codedx-tomcat:v2026.6.4
$ docker push id.dkr.ecr.us-east-2.amazonaws.com/codedx/codedx-tomcat:v2026.6.4
```
...
```
$ docker pull repo.blackduck.com/containers/codedx/codedx-tomcat:v2026.6.4
$ docker tag repo.blackduck.com/containers/codedx/codedx-tomcat:v2026.6.4 id.dkr.ecr.us-east-2.amazonaws.com/my-srm/codedx/codedx-tomcat:v2026.6.4
$ docker push id.dkr.ecr.us-east-2.amazonaws.com/my-srm/codedx/codedx-tomcat:v2026.6.4
```
...
- repo.blackduck.com/containers/codedx/codedx-tomcat:v2026.6.4
...
'codedx/codedx-tomcat:v2026.6.4' | ForEach-Object {
...
- repo.blackduck.com/containers/codedx/codedx-tools:v2026.6.4
- repo.blackduck.com/containers/codedx/codedx-prepare:v2.19.0
- repo.blackduck.com/containers/codedx/codedx-newanalysis:v2.19.0
- repo.blackduck.com/containers/codedx/codedx-results:v2.19.0
- repo.blackduck.com/containers/codedx/codedx-tool-service:v2.19.0
- repo.blackduck.com/containers/codedx/codedx-cleanup:v2.19.0
- repo.blackduck.com/containers/argoproj/workflow-controller:v3.7.11
- repo.blackduck.com/containers/argoproj/argoexec:v3.7.11
...
'codedx/codedx-tools:v2026.6.4',
'codedx/codedx-prepare:v2.19.0',
'codedx/codedx-newanalysis:v2.19.0',
'codedx/codedx-results:v2.19.0',
'codedx/codedx-tool-service:v2.19.0',
'codedx/codedx-cleanup:v2.19.0',
'bitnami/minio:2025.7.23-debian-12-r5',
'argoproj/workflow-controller:v3.7.11',
'argoproj/argoexec:v3.7.11' | ForEach-Object {
...
'codedx/codedx-tomcat:v2026.6.4',
'codedx/codedx-tools:v2026.6.4',
'codedx/codedx-prepare:v2.19.0',
'codedx/codedx-newanalysis:v2.19.0',
'codedx/codedx-results:v2.19.0',
