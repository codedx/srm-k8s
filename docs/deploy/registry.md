...
```
$ docker pull repo.blackduck.com/containers/codedx/codedx-tomcat:v2025.3.4
$ docker tag repo.blackduck.com/containers/codedx/codedx-tomcat:v2025.3.4 id.dkr.ecr.us-east-2.amazonaws.com/codedx/codedx-tomcat:v2025.3.4
$ docker push id.dkr.ecr.us-east-2.amazonaws.com/codedx/codedx-tomcat:v2025.3.4
```
...
```
$ docker pull repo.blackduck.com/containers/codedx/codedx-tomcat:v2025.3.4
$ docker tag repo.blackduck.com/containers/codedx/codedx-tomcat:v2025.3.4 id.dkr.ecr.us-east-2.amazonaws.com/my-srm/codedx/codedx-tomcat:v2025.3.4
$ docker push id.dkr.ecr.us-east-2.amazonaws.com/my-srm/codedx/codedx-tomcat:v2025.3.4
```
...
- repo.blackduck.com/containers/codedx/codedx-tomcat:v2025.3.4
...
'codedx/codedx-tomcat:v2025.3.4' | ForEach-Object {
...
- repo.blackduck.com/containers/codedx/codedx-tools:v2025.3.4
...
'codedx/codedx-tomcat:v2025.3.4',
'codedx/codedx-tools:v2025.3.4',
'codedx/codedx-prepare:v2.10.0',
'codedx/codedx-newanalysis:v2.10.0',
'codedx/codedx-results:v2.10.0',
