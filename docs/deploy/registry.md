...
```
$ docker pull repo.blackduck.com/containers/codedx/codedx-tomcat:v2025.3.1
$ docker tag repo.blackduck.com/containers/codedx/codedx-tomcat:v2025.3.1 id.dkr.ecr.us-east-2.amazonaws.com/codedx/codedx-tomcat:v2025.3.1
$ docker push id.dkr.ecr.us-east-2.amazonaws.com/codedx/codedx-tomcat:v2025.3.1
```
...
```
$ docker pull repo.blackduck.com/containers/codedx/codedx-tomcat:v2025.3.1
$ docker tag repo.blackduck.com/containers/codedx/codedx-tomcat:v2025.3.1 id.dkr.ecr.us-east-2.amazonaws.com/my-srm/codedx/codedx-tomcat:v2025.3.1
$ docker push id.dkr.ecr.us-east-2.amazonaws.com/my-srm/codedx/codedx-tomcat:v2025.3.1
```
...
- repo.blackduck.com/containers/codedx/codedx-tomcat:v2025.3.1
...
'codedx/codedx-tomcat:v2025.3.1' | ForEach-Object {
...
- repo.blackduck.com/containers/codedx/codedx-tools:v2025.3.1
...
'codedx/codedx-tomcat:v2025.3.1',
'codedx/codedx-tools:v2025.3.1',
'codedx/codedx-prepare:v2.9.0',
'codedx/codedx-newanalysis:v2.9.0',
'codedx/codedx-results:v2.9.0',
