...
```
$ docker pull repo.blackduck.com/containers/codedx/codedx-tomcat:v2024.12.3
$ docker tag repo.blackduck.com/containers/codedx/codedx-tomcat:v2024.12.3 id.dkr.ecr.us-east-2.amazonaws.com/codedx/codedx-tomcat:v2024.12.3
$ docker push id.dkr.ecr.us-east-2.amazonaws.com/codedx/codedx-tomcat:v2024.12.3
```
...
```
$ docker pull repo.blackduck.com/containers/codedx/codedx-tomcat:v2024.12.3
$ docker tag repo.blackduck.com/containers/codedx/codedx-tomcat:v2024.12.3 id.dkr.ecr.us-east-2.amazonaws.com/my-srm/codedx/codedx-tomcat:v2024.12.3
$ docker push id.dkr.ecr.us-east-2.amazonaws.com/my-srm/codedx/codedx-tomcat:v2024.12.3
```
...
- repo.blackduck.com/containers/codedx/codedx-tomcat:v2024.12.3
...
'codedx/codedx-tomcat:v2024.12.3' | ForEach-Object {
...
- repo.blackduck.com/containers/codedx/codedx-mariadb:v1.37.0
...
'codedx/codedx-mariadb:v1.37.0' | ForEach-Object {
...
- repo.blackduck.com/containers/codedx/codedx-tools:v2024.12.3
- repo.blackduck.com/containers/codedx/codedx-prepare:v2.8.0
- repo.blackduck.com/containers/codedx/codedx-newanalysis:v2.8.0
- repo.blackduck.com/containers/codedx/codedx-results:v2.8.0
- repo.blackduck.com/containers/codedx/codedx-tool-service:v2.8.0
- repo.blackduck.com/containers/codedx/codedx-cleanup:v2.8.0
...
'codedx/codedx-tools:v2024.12.3',
'codedx/codedx-prepare:v2.8.0',
'codedx/codedx-newanalysis:v2.8.0',
'codedx/codedx-results:v2.8.0',
'codedx/codedx-tool-service:v2.8.0',
'codedx/codedx-cleanup:v2.8.0',
...
'codedx/codedx-tomcat:v2024.12.3',
'codedx/codedx-tools:v2024.12.3',
'codedx/codedx-prepare:v2.8.0',
'codedx/codedx-newanalysis:v2.8.0',
'codedx/codedx-results:v2.8.0',
