...
```
$ docker pull repo.blackduck.com/containers/codedx/codedx-tomcat:v2026.3.2
$ docker tag repo.blackduck.com/containers/codedx/codedx-tomcat:v2026.3.2 id.dkr.ecr.us-east-2.amazonaws.com/codedx/codedx-tomcat:v2026.3.2
$ docker push id.dkr.ecr.us-east-2.amazonaws.com/codedx/codedx-tomcat:v2026.3.2
```
...
```
$ docker pull repo.blackduck.com/containers/codedx/codedx-tomcat:v2026.3.2
$ docker tag repo.blackduck.com/containers/codedx/codedx-tomcat:v2026.3.2 id.dkr.ecr.us-east-2.amazonaws.com/my-srm/codedx/codedx-tomcat:v2026.3.2
$ docker push id.dkr.ecr.us-east-2.amazonaws.com/my-srm/codedx/codedx-tomcat:v2026.3.2
```
...
- repo.blackduck.com/containers/codedx/codedx-tomcat:v2026.3.2
...
'codedx/codedx-tomcat:v2026.3.2' | ForEach-Object {
...
- repo.blackduck.com/containers/codedx/codedx-tools:v2026.3.2
- repo.blackduck.com/containers/codedx/codedx-prepare:v2.18.0
- repo.blackduck.com/containers/codedx/codedx-newanalysis:v2.18.0
- repo.blackduck.com/containers/codedx/codedx-results:v2.18.0
- repo.blackduck.com/containers/codedx/codedx-tool-service:v2.18.0
- repo.blackduck.com/containers/codedx/codedx-cleanup:v2.18.0
...
'codedx/codedx-tools:v2026.3.2',
'codedx/codedx-prepare:v2.18.0',
'codedx/codedx-newanalysis:v2.18.0',
'codedx/codedx-results:v2.18.0',
'codedx/codedx-tool-service:v2.18.0',
'codedx/codedx-cleanup:v2.18.0',
...
'codedx/codedx-tomcat:v2026.3.2',
'codedx/codedx-tools:v2026.3.2',
'codedx/codedx-prepare:v2.18.0',
'codedx/codedx-newanalysis:v2.18.0',
'codedx/codedx-results:v2.18.0',
