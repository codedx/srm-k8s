...
```
$ docker pull repo.blackduck.com/containers/codedx/codedx-tomcat:v2025.6.3
$ docker tag repo.blackduck.com/containers/codedx/codedx-tomcat:v2025.6.3 id.dkr.ecr.us-east-2.amazonaws.com/codedx/codedx-tomcat:v2025.6.3
$ docker push id.dkr.ecr.us-east-2.amazonaws.com/codedx/codedx-tomcat:v2025.6.3
```
...
```
$ docker pull repo.blackduck.com/containers/codedx/codedx-tomcat:v2025.6.3
$ docker tag repo.blackduck.com/containers/codedx/codedx-tomcat:v2025.6.3 id.dkr.ecr.us-east-2.amazonaws.com/my-srm/codedx/codedx-tomcat:v2025.6.3
$ docker push id.dkr.ecr.us-east-2.amazonaws.com/my-srm/codedx/codedx-tomcat:v2025.6.3
```
...
- repo.blackduck.com/containers/codedx/codedx-tomcat:v2025.6.3
...
'codedx/codedx-tomcat:v2025.6.3' | ForEach-Object {
...
- repo.blackduck.com/containers/codedx/codedx-mariadb:v1.38.0
...
'codedx/codedx-mariadb:v1.38.0' | ForEach-Object {
...
- repo.blackduck.com/containers/cache-service:2024.12.0
- repo.blackduck.com/containers/common-infra:2024.12.0
- repo.blackduck.com/containers/scan-service:2024.12.0
- repo.blackduck.com/containers/scan-service-migration:2024.12.0
- repo.blackduck.com/containers/storage-service:2024.12.0
- repo.blackduck.com/containers/storage-service-migration:2024.12.0
- repo.blackduck.com/containers/job-runner:2024.12.0
...
- repo.blackduck.com/containers/codedx/codedx-tools:v2025.6.3
- repo.blackduck.com/containers/codedx/codedx-prepare:v2.13.0
- repo.blackduck.com/containers/codedx/codedx-newanalysis:v2.13.0
- repo.blackduck.com/containers/codedx/codedx-results:v2.13.0
- repo.blackduck.com/containers/codedx/codedx-tool-service:v2.13.0
- repo.blackduck.com/containers/codedx/codedx-cleanup:v2.13.0
- repo.blackduck.com/containers/argoproj/workflow-controller:v3.6.10
- repo.blackduck.com/containers/argoproj/argoexec:v3.6.10
- repo.blackduck.com/containers/bitnami/minio:2025.7.23-debian-12-r0 (when not using external workflow storage)
...
'codedx/codedx-tools:v2025.6.3',
'codedx/codedx-prepare:v2.13.0',
'codedx/codedx-newanalysis:v2.13.0',
'codedx/codedx-results:v2.13.0',
...
'argoproj/argoexec:v3.6.10' | ForEach-Object {
...
'codedx/codedx-tomcat:v2025.6.3',
'codedx/codedx-tools:v2025.6.3',
'codedx/codedx-prepare:v2.13.0',
'codedx/codedx-newanalysis:v2.13.0',
'codedx/codedx-results:v2.13.0',
