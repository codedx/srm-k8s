...
```
$ docker pull repo.blackduck.com/containers/codedx/codedx-tomcat:v2025.9.5
$ docker tag repo.blackduck.com/containers/codedx/codedx-tomcat:v2025.9.5 id.dkr.ecr.us-east-2.amazonaws.com/codedx/codedx-tomcat:v2025.9.5
$ docker push id.dkr.ecr.us-east-2.amazonaws.com/codedx/codedx-tomcat:v2025.9.5
```
...
```
$ docker pull repo.blackduck.com/containers/codedx/codedx-tomcat:v2025.9.5
$ docker tag repo.blackduck.com/containers/codedx/codedx-tomcat:v2025.9.5 id.dkr.ecr.us-east-2.amazonaws.com/my-srm/codedx/codedx-tomcat:v2025.9.5
$ docker push id.dkr.ecr.us-east-2.amazonaws.com/my-srm/codedx/codedx-tomcat:v2025.9.5
```
...
- repo.blackduck.com/containers/codedx/codedx-tomcat:v2025.9.5
...
'codedx/codedx-tomcat:v2025.9.5' | ForEach-Object {
...
- repo.blackduck.com/containers/codedx/codedx-tools:v2025.9.5
...
'codedx/codedx-tomcat:v2025.9.5',
'codedx/codedx-tools:v2025.9.5',
'codedx/codedx-prepare:v2.17.0',
'codedx/codedx-newanalysis:v2.17.0',
'codedx/codedx-results:v2.17.0',
