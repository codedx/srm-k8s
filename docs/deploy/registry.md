...
```
$ docker pull repo.blackduck.com/containers/codedx/codedx-tomcat:v2025.6.2
$ docker tag repo.blackduck.com/containers/codedx/codedx-tomcat:v2025.6.2 id.dkr.ecr.us-east-2.amazonaws.com/codedx/codedx-tomcat:v2025.6.2
$ docker push id.dkr.ecr.us-east-2.amazonaws.com/codedx/codedx-tomcat:v2025.6.2
```
...
```
$ docker pull repo.blackduck.com/containers/codedx/codedx-tomcat:v2025.6.2
$ docker tag repo.blackduck.com/containers/codedx/codedx-tomcat:v2025.6.2 id.dkr.ecr.us-east-2.amazonaws.com/my-srm/codedx/codedx-tomcat:v2025.6.2
$ docker push id.dkr.ecr.us-east-2.amazonaws.com/my-srm/codedx/codedx-tomcat:v2025.6.2
```
...
- repo.blackduck.com/containers/codedx/codedx-tomcat:v2025.6.2
...
'codedx/codedx-tomcat:v2025.6.2' | ForEach-Object {
...
- repo.blackduck.com/containers/codedx/codedx-tools:v2025.6.2
...
- repo.blackduck.com/containers/bitnami/minio:2025.6.13-debian-12-r0 (when not using external workflow storage)
...
'codedx/codedx-tomcat:v2025.6.2',
'codedx/codedx-tools:v2025.6.2',
'codedx/codedx-prepare:v2.13.0',
'codedx/codedx-newanalysis:v2.13.0',
'codedx/codedx-results:v2.13.0',
